...
class Prediction_Helper:
    ...
    def Get_Results(self,Task_Text,Task_Result):
        ...
        if self.model_handler is None:
            ...
            self.model_handler=Prediction_Model.create_llm_remote(self.model_id, self.max_memory , self.tokenizer, self.Relevance_Map_Method,self.Baselines, num_gpus=self.num_gpus,num_cpus=self.num_cpus)
